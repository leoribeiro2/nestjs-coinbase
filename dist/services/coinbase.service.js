...
var Charge = coinbase_commerce_node_1.resources.Charge;
let CoinbaseService = class CoinbaseService {
    constructor(options) {
        ...
        coinbase_commerce_node_1.Client.init(options.apiKey);
    }
...
CoinbaseService = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject(common_2.COINBASE_MODULE_OPTIONS)),
